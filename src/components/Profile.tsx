...
const Profile = () => {
  ...
  const openProfileButton = () => {
    ...
    return (
      ...
      >
        <img
          src={`${openProfile ? globalWhiteEmpty : lockWhiteFilled}`}
          alt=""
          className="ml-1 w-[20px] lg:ml-0 lg:w-[25px]"
        />
        <div className="ml-1 lg:ml-0">{openProfile ? 'Public Profile' : 'Private Profile'}</div>
      </button>
    )
  }
