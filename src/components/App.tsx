...
//2 Liking and disliking from (in Current Known Problems)
...
//4 Comments:
//2 Posts and comments have an issue with the like-count and dislike-count. The images load correctly, but the count does not. This is most noticeable when the user chooses to see comments, likes/dislikes the comments, then closes the comment section, followed by opening it again.
//2 Comment deletion doesn't instantly reflect in the UI such as post deletion does.
//4 Loading:
